...
#--- evts for prediction:
infile = "shuffledcsv_20hits_perevt.csv"
#
...
df0 = pd.read_csv(filein, index_col=0)
print(df0.head())
#remove lines with nan values:events with hits<20
df = df0.dropna()
print(df.head)
print(df.shape)
...
hitx, hity, hitz, hitT, totalPMTs, recovertex0, labels, gridpoint, nhits, recoVtxFOM, TrueTrackLengthInMRD = np.split(Dataset,[20,40,60,80,81,84,87,88,89,90],axis=1)
